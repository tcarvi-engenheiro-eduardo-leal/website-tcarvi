...
function toIterator(parts, clone = true) {
  return __asyncGenerator(this, null, function* () {
    ...
    _Blob = class Blob {
      ...
      text() {
        return __async(this, null, function* () {
          ...
          let str = "";
          try {
            for (var iter = __forAwait(toIterator(this.#parts, false)), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
    ...
    BlobDataItem = class _BlobDataItem {
      ...
      stream() {
        return __asyncGenerator(this, null, function* () {
          const {
            mtimeMs
          } = yield new __await(stat(this.#path));
          if (mtimeMs > this.lastModified) {
            throw new import_node_domexception.default("The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.", "NotReadableError");
          }
          yield* __yieldStar(createReadStream(this.#path, {
            start: this.#start,
...
*/
//# sourceMappingURL=chunk-QZT7DHEC.js.map
